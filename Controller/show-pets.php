        ...
        while ($row = mysqli_fetch_array($res)) {
							...
							echo'<tbody>
								<tr class="text-center  ftco-animate">
									...
									<td class="image-prod"><div class="img" style="background-image:url(../View/images/pet_images/'.$row['imagename'].');"></div></td>
                                    ...
                                    <td class="product-name">
                                        <form action="../Controller/set_pet_filter.php" method="GET">
