    ...
    if (mysqli_num_rows($res) > 0) {
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="../Controller/logout.php" class="nav-link">Log out <span class="icon-sign-out"></span></a></li>
		...
		<div class="parallax-img d-flex align-items-center" >
			<div class="container">
            <form action="../Controller/search-inventory-user.php" method="GET" id="search-inventory-user-form">
            ...
            <thead><tr>
              ...
              ';
      $operation="search"; include "../Controller/pet_list.php";
...
';
                        if(isset($_SESSION['pet_id_filter_user'])) {
                            ...
                            echo '  <p>
                                    ...
                                    <form action="../Controller/clear_pet_filter_user.php" method="GET">
        ...
        while ($row = mysqli_fetch_array($res)) {
							...
							echo'<tbody>
                                <tr class="text-center  ftco-animate">
									<td class="image-prod"><div class="img" style="background-image:url(../View/images/product_images/'.$row['imagename'].');"></div></td>
									</td>
                                ...
                                <form action="../Controller/add_to_cart.php" class="input-group col-md-8 d-flex mb-3" method="GET">
                                    <td class="price">
